...
function builder(options) {
  ...
  if (!options.network) {
    options.network = bchLib.Networks.defaultNetwork;
  }

  options.Block = options.Block || bchLib.Block;
  options.BlockHeader = options.BlockHeader || bchLib.BlockHeader;
  options.Transaction = options.Transaction || bchLib.Transaction;
  options.MerkleBlock = options.MerkleBlock || bchLib.MerkleBlock;
