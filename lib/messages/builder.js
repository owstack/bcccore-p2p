...
function builder(options) {
  ...
  if (!options.network) {
    options.network = bcccore.Networks.defaultNetwork;
  }

  options.Block = options.Block || bcccore.Block;
  options.BlockHeader = options.BlockHeader || bcccore.BlockHeader;
  options.Transaction = options.Transaction || bcccore.Transaction;
  options.MerkleBlock = options.MerkleBlock || bcccore.MerkleBlock;
